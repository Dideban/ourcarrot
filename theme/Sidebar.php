		<div class="col-sm-3 col-md-2 sidebar coloor">
            ...
            <?php if(!isset($_SESSION['ID']) or empty($_SESSION['ID'])){ ?>
            ...
            <?php }else{ ?>
            <ul class="nav nav-sidebar dash_top" role="tablist"><!-- قبل از ورود فرم تماس نمایش داده بشه و بعد از ورود دوتا لیست بالایی! -->
				<li role="presentation"><a href="#">خوش آمدید <?=$_SESSION['fullname'];?></a></li>
				<li role="presentation"><a href="SignOut">خروج</a></li>
			</ul>
            <?php } ?>
